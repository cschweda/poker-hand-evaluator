/**
 * @constant {string[]} RANKS - Valid card ranks from lowest (2) to highest (A)
 */
export const RANKS = [
  "2",
  "3",
...
/**
 * @constant {string[]} SUITS - Valid card suits (Clubs, Diamonds, Hearts, Spades)
 */
export const SUITS = ["C", "D", "H", "S"];

/**
 * @constant {string[]} HANDS - Poker hand rankings from lowest (Invalid Hand) to highest (Straight Flush)
 */
export const HANDS = [
  "Invalid Hand",
  "High Card",
...
export async function runTests() {
  const { testHands, errorTests } = await import('./src/testCases.js');
